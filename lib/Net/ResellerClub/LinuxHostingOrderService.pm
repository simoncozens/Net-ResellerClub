package Net::ResellerClub::LinuxHostingOrderService;
...
# -- generated from file:../../APIKit/HostingKIT/cgi-bin/lib/wsdl/LinuxHostingOrder.wsdl
my %methods = (
add => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.hosting.web.linux.LinuxHostingOrder',
    parameters => [
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.web.linux.LinuxHostingOrder","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.web.linux.LinuxHostingOrder","impl");
