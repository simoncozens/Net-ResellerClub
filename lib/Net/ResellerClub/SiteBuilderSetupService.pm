package Net::ResellerClub::SiteBuilderSetupService;
...
# -- generated from file:../../APIKit/OtherProductsKIT/cgi-bin/lib/wsdl/SiteBuilderSetup.wsdl
my %methods = (
getPricingKeyPricingParamMap => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.sitebuilder.SiteBuilderSetup',
    parameters => [
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.sitebuilder.SiteBuilderSetup","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.sitebuilder.SiteBuilderSetup","impl");
