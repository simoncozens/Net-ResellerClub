package Net::ResellerClub::WebHostingOrderDataService;
...
# -- generated from file:../../APIKit/HostingKIT/cgi-bin/lib/wsdl/WebHostingOrderData.wsdl
my %methods = (
getHostingMetaData => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.hosting.web.WebHostingOrderData',
    parameters => [
...
list => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'hostingType', type => 'xsd:string', attr => {}),
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.web.WebHostingOrderData","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.web.WebHostingOrderData","impl");
