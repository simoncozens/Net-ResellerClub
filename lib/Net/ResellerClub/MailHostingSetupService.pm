package Net::ResellerClub::MailHostingSetupService;
...
# -- generated from file:../../APIKit/HostingKIT/cgi-bin/lib/wsdl/MailHostingSetup.wsdl
my %methods = (
getPricingKeyPricingParamMap => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.hosting.email.MailHostingSetup',
    parameters => [
...
getHostingParamsDisplayName => {
  ...
  }, # end getHostingParamsDisplayName
); # end my %methods
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.email.MailHostingSetup","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.email.MailHostingSetup","impl");
