package Net::ResellerClub::WindowsHostingOrderService;
...
# -- generated from file:../../APIKit/HostingKIT/cgi-bin/lib/wsdl/WindowsHostingOrder.wsdl
my %methods = (
add => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.hosting.web.windows.WindowsHostingOrder',
    parameters => [
      ...
      SOAP::Data->new(name => 'ssl', type => 'xsd:boolean', attr => {}),
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.web.windows.WindowsHostingOrder","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.web.windows.WindowsHostingOrder","impl");
