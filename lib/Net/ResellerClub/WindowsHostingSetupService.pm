package Net::ResellerClub::WindowsHostingSetupService;
...
# -- generated from file:../../APIKit/HostingKIT/cgi-bin/lib/wsdl/WindowsHostingSetup.wsdl
my %methods = (
getPricingKeyPricingParamMap => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.hosting.web.windows.WindowsHostingSetup',
    parameters => [
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.web.windows.WindowsHostingSetup","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.web.windows.WindowsHostingSetup","impl");
