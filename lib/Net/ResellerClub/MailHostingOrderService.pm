package Net::ResellerClub::MailHostingOrderService;
# Generated by SOAP::Lite (v0.710.10) for Perl -- soaplite.com
# Copyright (C) 2000-2006 Paul Kulchenko, Byrne Reese
# -- generated at [Wed May 26 15:19:20 2010]
# -- generated from file:../../APIKit/HostingKIT/cgi-bin/lib/wsdl/MailHostingOrder.wsdl
my %methods = (
add => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.hosting.email.MailHostingOrder',
    parameters => [
...
getModPricing => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'noOfMonths', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'packagekey', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'excessBandwidth', type => 'xsd:int', attr => {}),
    ], # end parameters
  }, # end getModPricing
...
mod => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'noOfMonths', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'packagekey', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'additionalMailBoxes', type => 'xsd:int', attr => {}),
    ], # end parameters
  }, # end mod
list => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.email.MailHostingOrder","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.email.MailHostingOrder","impl");
