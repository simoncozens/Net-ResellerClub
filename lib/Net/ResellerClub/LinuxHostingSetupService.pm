package Net::ResellerClub::LinuxHostingSetupService;
...
# -- generated from file:../../APIKit/HostingKIT/cgi-bin/lib/wsdl/LinuxHostingSetup.wsdl
my %methods = (
getPricingKeyPricingParamMap => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.hosting.web.linux.LinuxHostingSetup',
    parameters => [
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.web.linux.LinuxHostingSetup","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.hosting.web.linux.LinuxHostingSetup","impl");
