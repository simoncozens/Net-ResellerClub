package Net::ResellerClub::EngageOrderService;
...
# -- generated from file:../../APIKit/OtherProductsKIT/cgi-bin/lib/wsdl/EngageOrder.wsdl
my %methods = (
add => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.instahelp.EngageOrder',
    parameters => [
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.instahelp.EngageOrder","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.instahelp.EngageOrder","impl");
