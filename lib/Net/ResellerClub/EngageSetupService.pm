package Net::ResellerClub::EngageSetupService;
...
# -- generated from file:../../APIKit/OtherProductsKIT/cgi-bin/lib/wsdl/EngageSetup.wsdl
my %methods = (
getPricingKeyPricingParamMap => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.instahelp.EngageSetup',
    parameters => [
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.instahelp.EngageSetup","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.instahelp.EngageSetup","impl");
