package Net::ResellerClub::SiteBuilderService;
# Generated by SOAP::Lite (v0.710.10) for Perl -- soaplite.com
# Copyright (C) 2000-2006 Paul Kulchenko, Byrne Reese
# -- generated at [Wed May 26 15:19:22 2010]
# -- generated from file:../../APIKit/OtherProductsKIT/cgi-bin/lib/wsdl/SiteBuilder.wsdl
my %methods = (
add => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.sitebuilder.SiteBuilder',
    parameters => [
      ...
      SOAP::Data->new(name => 'noOfMonths', type => 'xsd:int', attr => {}),
...
modOrderFTPDetails => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'entityId', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'ftphost', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'ftpport', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'ftpusername', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'ftppassword', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'ftppath', type => 'xsd:string', attr => {}),
    ], # end parameters
  }, # end modOrderFTPDetails
getOrderIdByDomain => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.sitebuilder.SiteBuilder',
...
renew => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'orderId', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'renewMonths', type => 'xsd:int', attr => {}),
    ], # end parameters
  }, # end renew
...
getMonthlyCostAndValidate => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'SERVICE_PARENTID', type => 'xsd:int', attr => {}),
      SOAP::Data->new(name => 'productkey', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'packageKey', type => 'xsd:string', attr => {}),
    ], # end parameters
  }, # end getMonthlyCostAndValidate
getAllPackDetails => {
    endpoint => 'http://demo.myorderbox.com/anacreon/servlet/APIv3-XML',
    soapaction => '',
    namespace => 'com.logicboxes.foundation.sfnb.order.sitebuilder.SiteBuilder',
...
sub _call {
  ...
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.sitebuilder.SiteBuilder","intf");
  $self->serializer->register_ns("http://xml.apache.org/xml-soap","apachesoap");
  $self->serializer->register_ns("com.logicboxes.foundation.sfnb.order.sitebuilder.SiteBuilder","impl");
